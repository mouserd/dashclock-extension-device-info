...
public class MyDeviceExtensionActivity extends PreferenceActivity {
  ...
  private void setupSimplePreferencesScreen() {
    ...
    bindPreferenceSummaryToValue(findPreference(MyDeviceExtension.ALTERNATE_DEVICE_NAME));
    bindPreferenceSummaryToValue(findPreference(MyDeviceExtension.USE_SYSTEM_DEVICE_NAME));
  }
